...
```powershell
Invoke-RestMethod -Uri "http://localhost:5678/webhook-test/registro-incidencia" -Method POST -Body (@{nombre="Maria Lopez"; incidencia="Problema con impresora"; prioridad="baja"} | ConvertTo-Json) -ContentType "application/json"
```
